      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-20">
          <Link href="/" className="text-2xl font-bold text-white">
            Auto Socorro <span className="text-orange-500">Express</span>
          </Link>

          <div className="hidden md:flex items-center gap-8">
            <a href="#servicos" className="text-zinc-300 hover:text-white transition-colors">
              Serviços
            </a>
            <a href="#como-funciona" className="text-zinc-300 hover:text-white transition-colors">
              Como Funciona
            </a>
            <a href="#galeria" className="text-zinc-300 hover:text-white transition-colors">
              Galeria
            </a>
            <a href="#depoimentos" className="text-zinc-300 hover:text-white transition-colors">
              Depoimentos
            </a>
          </div>
